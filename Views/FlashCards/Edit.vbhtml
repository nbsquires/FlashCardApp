...
@Using (Html.BeginForm())
    ...
    @<div class="form-horizontal">
        ...
        <div class="form-group">
            @Html.LabelFor(Function(model) model.QuestionID, "QuestionID", htmlAttributes:= New With { .class = "control-label col-md-2" })
            <div class="col-md-10">
                @Html.DropDownList("QuestionID", Nothing, htmlAttributes:= New With { .class = "form-control" })
                @Html.ValidationMessageFor(Function(model) model.QuestionID, "", New With { .class = "text-danger" })
            </div>
        </div>
